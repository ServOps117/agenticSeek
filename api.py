...
api = FastAPI(title="AI Stock Analyst API", version="0.1.0")
...
if __name__ == "__main__":
    ...
    if is_running_in_docker():
        print("[AI Stock Analyst] Starting in Docker container...")
    else:
        print("[AI Stock Analyst] Starting on host machine...")
